...
# Replicate each list 1000 times to create a larger dataset
...
print(f"Sequential execution time: {execution_time_ms:.2f} milliseconds")
print(f"Accuracy: {accuracy:.4f}")

# Test prediction with a new comment
test_comment = ["Video is not good"]
